export const questions = [
    ...
    { description: 'Você pretende levar crianças na viagem?', possibilityOne:'Sim', possibilityTwo:'Não' },
    { description: 'Você pretende levar seu pet na viagem?', possibilityOne:'Sim', possibilityTwo:'Não' },
    { description: 'Você geralmente anda com muitos objetos de alto valor em suas viagens?', possibilityOne:'Sim', possibilityTwo:'Não' }
]